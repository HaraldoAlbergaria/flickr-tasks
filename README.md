...
### [**_add_description/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/add_description)
   - **_add-description.py_**: Automatically add or append a description to photos on a photoset.
   
### [**_add_gear_tags/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/add_gear_tags)
   - **_add-gear-tags.py_**: Automatically add tags for the gear used (eg: camera model, lens model) according to exif data.
   
### [**_auto_add2groups/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/auto_add2groups)
...
### [**_auto_post2blogs/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/auto_post2blogs)
   - **_post-photo-to-blogs.py_**: Automatically post photos to all the blogs configured in the user's account.

### [**_auto_tasks/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/auto_tasks)
...
### [**_best_lens/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/best_lens)
...
### [**_check_exif/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/check_exif)
...
### [**_del_img_comments/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/del_img_comments)
...
### [**_empty_photoset/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/empty_photoset)
   - **_empty-photoset.py_**: Empties a given photoset, leaving just 1 photo to avoid the photoset being excluded.
    
### [**_find_explored/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/find_explored)
...
### [**_generate_kml/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/generate_kml)
...
### [**_group_admin/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/group_admin)
...
### [**_lens_usage/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/lens_usage)
...
### [**_lenses_wide_open/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/lenses_wide_open)
...
### [**_more_stats/_**](https://github.com/HaraldoAlbergaria/flickr-tasks/tree/master/more_stats)
